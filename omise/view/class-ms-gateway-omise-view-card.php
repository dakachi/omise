...
class MS_Gateway_Omise_View_Card extends MS_View {
			...
			<div class="ms-wrap ms-card-info-wrapper">
				...
				<table class="ms-table">
					<tbody>
						...
						<tr>
							<td><?php echo '**** **** **** '. $this->data['omise']['card_num']; ?></td>
							<td><?php echo '' . $this->data['omise']['card_exp']; ?></td>
						</tr>
					</tbody>
				</table>
				<form action="" method="post">
					...
					?>
					<script
						src="https://checkout.omise.com/checkout.js" class="omise-button"
