...
class MS_Gateway_Omise_View_Settings extends MS_View {
	...
	public function to_html() {
		...
		<form class="ms-gateway-settings-form ms-form">
			...
			$description = sprintf(
				...
				sprintf(
					__( 'You can find your omise API Keys in your %sAccount Settings%s.', 'membership2' ),
					'<a href="https://dashboard.omise.com/account/apikeys" target="_blank">',
					'</a>'
				)
			);
